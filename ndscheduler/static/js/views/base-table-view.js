...
define(['utils',
  ...
  return Backbone.View.extend({
    ...
    /**
     * Refresh handler.  Bound to the collection's 'reset' event and, by some
     * pages, to refresh controls.  Re-fetches the data via refreshCollection().
     *
     * @param {object=} e Optional DOM event when triggered by a control.
     */
     ...
     *
     * 'reset' is wired here too: jobs re-triggers it after add/edit/delete to
     * force a refresh, and collections that never fire it (executions, logs)
     * simply keep an inert listener.  Pages therefore no longer need to
     * re-declare this -- they only override refreshCollection().
     */
